/*! vex.combined.js: vex 3.0.0, vex-dialog 1.0.6 */ ! function(a) {
 ...
 return function b(a, c, d) {
       ...
       var d = a("domify"),
        ...
        g = function(a) {
         ...
         for (var c = 0; c < a.length; c++) {
          ...
          e.type = d.type, e.textContent = d.text, e.classList.add(d.className), e.classList.add("vex-dialog-button"), 0 === c ? e.classList.add("vex-first") : c === a.length - 1 && e.classList.add("vex-last"),
           function(a) {
         ...
         var b = {
          ...
          open: function(b) {
           ...
           if (e.options.beforeClose = function() {
            ...
            var i = e.contentEl.querySelector("button, input, textarea");
            i && i.focus()
           }
           return e
          },
  ...
  7: [function(a, b, c) {
   ...
   }), window.addEventListener("popstate", l.closeAll), l.defaultOptions = {
    content: "",
    showCloseButton: !0,
